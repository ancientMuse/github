...
<html>
	<head>
		...
		<script src="res/script/AutoMissionStart.js"></script>
		...
		<style type="text/css">
			...
			.missionType select{
			     box-shadow: 0px 0px 2px 1px #87CEFF;   
			     font-size:15px;
			     border-radius:3px;
	...
	<body>
	  ...
	  <div id="MSGlight" class="msghwhite_content">
	    <div class="title" id="title">
			...
			<div class="content" id="MSGcontent"></div>       <!--MSGlight&MSGfade为自动演示完后的提示框-->
	  </div>
	  <div id="fade" class="black_overlay"></div>           <!--light和fade两个系统发送指令后显示查看指令页面-->
		...
		<div class="bd">
		  <div id="messages" class="message"></div>       <!--messages左边的框-->
		  <div class="SectorMSG" id="showmsg"></div>      <!--SectorMSG中间的框-->
			<div class="SectorList">                        <!--SectorList右边的框-->
			  <div class="missionType">
			    <span style="font-weight:bold;color:#EE5C42">选择任务类型</span>
			    &nbsp;
			    <select id="MissionType">
			    	<option value="战前筹划">战前筹划</option>
			    	<option value="作战实施">作战实施</option>
			    </select>
			    <button id="MissionStart">开始任务</button>
			  </div>
